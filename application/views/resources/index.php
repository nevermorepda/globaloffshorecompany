		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("news/{$nation_alias}/{$items[0]->alias}")?>">
						<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[0]->thumbnail?>);">
							<div class="info">
								...
								<a href="<?=site_url("news/{$nation_alias}/{$items[0]->alias}")?>" class="btn-viewmore">View more</a>
								<div class="date">
			...
			<div class="col-md-8">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[1]->alias}")?>">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[1]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[2])) { $nation_alias = $this->m_nation->load($items[2]->nation_id)->alias;?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[2]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[2]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[3])) { $nation_alias = $this->m_nation->load($items[3]->nation_id)->alias;?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[3]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[3]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="row">
					...
					<div class="col-md-5">
						<a href="<?=site_url("news/{$nation_alias}/{$items[4]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[4]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					...
					<div class="col-md-7">
						<div class="mer-item border-red">
							<a href="<?=site_url("news/{$nation_alias}/{$items[5]->alias}")?>">
								<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[5]->thumbnail?>);">
									<div class="info">
										...
										<a href="<?=site_url("news/{$nation_alias}/{$items[5]->alias}")?>" class="btn-viewmore">View more</a>
										<div class="date">
			...
			<div class="col-md-5">
				<div class="row">
					...
					<div class="col-md-6">
						<a href="<?=site_url("news/{$nation_alias}/{$items[6]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[6]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[7])) { $nation_alias = $this->m_nation->load($items[7]->nation_id)->alias;?>
					<div class="col-md-6">
						<a href="<?=site_url("news/{$nation_alias}/{$items[7]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[7]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
		...
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[8]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[8]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[9])) { $nation_alias = $this->m_nation->load($items[9]->nation_id)->alias;?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[9]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[9]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[10])) { $nation_alias = $this->m_nation->load($items[10]->nation_id)->alias;?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$nation_alias}/{$items[10]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("news/{$nation_alias}/{$items[10]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("news/{$nation_alias}/{$items[11]->alias}")?>">
						<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[11]->thumbnail?>);">
							<div class="info">
								...
								<a href="<?=site_url("news/{$nation_alias}/{$items[11]->alias}")?>" class="btn-viewmore">View more</a>
								<div class="date">
