...
<script type="text/javascript">
	...
	tinymce.init({
		selector: '.tinymce',
		theme: 'modern',
		fontsize_formats: '8pt 9pt 10pt 11pt 12pt 13pt 14pt 15pt 16pt 17pt 18pt 19pt 20pt 22pt 24pt 25pt 26pt 28pt 30pt 32pt 34pt 35pt 36pt 38pt 40pt',
		convert_urls: false,
		plugins: [
		...
		toolbar: 'insertfile undo redo | removeformat | styleselect | fontselect fontsizeselect | bold italic | forecolor backcolor | table | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | code | template',
		content_css: [
			'<?=CSS_URL?>style.css',
		...
		templates: [
			...
			{title: 'List group', content: '<?=LIST_GROUP?>'},
			{title: 'Thumbnail', content: '<?=THUMBNAIL?>'},
			{title: 'Grid 1', content: '<?=GRID_MD_1?>'},
			{title: 'Grid 2', content: '<?=GRID_MD_2?>'},
			{title: 'Grid 3', content: '<?=GRID_MD_3?>'},
			{title: 'Grid 4', content: '<?=GRID_MD_4?>'},
			{title: 'Grid 6', content: '<?=GRID_MD_6?>'},
			{title: 'Grid 12', content: '<?=GRID_MD_12?>'},
			{title: 'Grid 4-8', content: '<?=GRID_MD_4_8?>'},
			{title: 'Grid 8-4', content: '<?=GRID_MD_8_4?>'},
			{title: 'Grid 3-9', content: '<?=GRID_MD_3_9?>'},
			{title: 'Grid 9-3', content: '<?=GRID_MD_9_3?>'},
