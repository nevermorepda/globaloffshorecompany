		...
		<div class="container">
			<div style="position: relative;">
				...
				<div class="owl-carousel owl-theme carousel-resources">
					<div class="item" data-merge="2">
						<div class="mer-item">
							<div class="bg-item" style="background-image: url(<?=BASE_URL.$module_items[0]->thumbnail?>);">
								<div class="info">
									<a href="<?=site_url("blogs/{$module_items[0]->alias}")?>">
										<h5 class="title-item"><?=$module_items[0]->title?></h5>
										<p>
										<?=word_limiter(strip_tags($module_items[0]->summary), 35)?>
										</p>
									</a>
									<a href="<?=site_url("blogs/{$module_items[0]->alias}")?>" class="btn-viewmore">View more</a>
									<div class="date">
					...
					<? for ($i=1; $i < $c; $i++) { ?>
					<div class="item">
						<a href="<?=site_url("blogs/{$module_items[$i]->alias}")?>">
							<div class="re-item">
						...
						<a href="<?=site_url("blogs/{$module_items[$i]->alias}")?>" class="btn btn-viewmore">view more</a>
					</div>
					<? } ?>
				</div>
