		...
		<div class="container">
			<div style="position: relative;">
				...
				<div class="owl-carousel owl-theme carousel-resources">
					<div class="item" data-merge="2">
						<div class="mer-item">
							<div class="bg-item" style="background-image: url(<?=BASE_URL.$resources[0]->thumbnail?>);">
								<div class="info">
									<a href="<?=site_url("news/{$resources[0]->alias}")?>">
					...
					<? for ($i=1; $i < $c; $i++) { ?>
					<div class="item">
						<a href="<?=site_url("news/{$resources[$i]->alias}")?>">
							<div class="re-item">
								<div class="bg-re-item" style="background-image: url(<?=BASE_URL.$resources[$i]->thumbnail?>);">
									<div class="date">
										<label><?=date('d',strtotime($resources[$i]->created_date))?></label><br>
										<label style="border-top: 1px solid #e6e6e6; font-size: 13px;"><?=date('M',strtotime($resources[$i]->created_date))?></label>
									</div>
								</div>
							</div>
