<div class="banner" style="background-image: url('<?=IMG_URL?>banner_services_company.jpg')">
	<div class="container">
		<h2>CONTENT</h2>
		<div style="display: table;"><i class="fas fa-angle-right"></i><h1><?=$category->name?></h1></div>
	</div>
</div>
<div class="cluster">
		...
		<div class="row">
			...
			<div class="col-md-3" style="padding-right: 0;">
				<div class="input-group mb-3">
					<input type="text" class="form-control" name="search" placeholder="Search <?=$category->name?>" value="<?=$search_text?>" aria-label="Search News" aria-describedby="button-addon2">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("resources/{$items[0]->alias}")?>">
						<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[0]->thumbnail?>);">
							<div class="info">
								...
								<a href="<?=site_url("resources/{$items[0]->alias}")?>" class="btn-viewmore">View more</a>
								<div class="date">
			...
			<div class="col-md-8">
				<div class="row">
					<? if (!empty($items[1])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[1]->alias}")?>">
							...
							<a href="<?=site_url("resources/{$items[1]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[2])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[2]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[2]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[3])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[3]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[3]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="row">
					<? if (!empty($items[4])) { ?>
					<div class="col-md-5">
						<a href="<?=site_url("resources/{$items[4]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[4]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[5])) { ?>
					<div class="col-md-7">
						<div class="mer-item border-red">
							<a href="<?=site_url("resources/{$items[5]->alias}")?>">
								<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[5]->thumbnail?>);">
									<div class="info">
										...
										<a href="<?=site_url("resources/{$items[5]->alias}")?>" class="btn-viewmore">View more</a>
										<div class="date">
			...
			<div class="col-md-5">
				<div class="row">
					<? if (!empty($items[6])) { ?>
					<div class="col-md-6">
						<a href="<?=site_url("resources/{$items[6]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[6]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[7])) { ?>
					<div class="col-md-6">
						<a href="<?=site_url("resources/{$items[7]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[7]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
		...
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<? if (!empty($items[8])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[8]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[8]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[9])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[9]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[9]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
					<? if (!empty($items[10])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("resources/{$items[10]->alias}")?>">
							<div class="re-item border-red">
							...
							<a href="<?=site_url("resources/{$items[10]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("resources/{$items[11]->alias}")?>">
						<div class="bg-item" style="background-image: url(<?=BASE_URL.$items[11]->thumbnail?>);">
							<div class="info">
								...
								<a href="<?=site_url("resources/{$items[11]->alias}")?>" class="btn-viewmore">View more</a>
								<div class="date">
