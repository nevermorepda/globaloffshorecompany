		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<table class="table table-bordered table-hover">
				...
				<tr class="row<?=$item->active?>">
					...
					<td>
						<a href="<?=site_url("syslog/faq/edit/{$item->id}")?>"><?=$item->title?></a>
						<ul class="action-icon-list">
							<li><a href="<?=site_url("syslog/faq/edit/{$item->id}")?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></li>
