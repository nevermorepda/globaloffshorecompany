	...
	<div class="container-fluid">
		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="table-head text-right" width="10%">Flag</td>
					<td><input type="text" id="file_path" name="file_path" class="form-control" value="<?=$item->file_path?>" onclick="openKCFinder4Textbox(this)" value="Click here and select a file double clicking on it"></td>
				</tr>
				<tr>
