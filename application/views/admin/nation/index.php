	...
	<div class="container-fluid">
			...
			<h1 class="page-title">
				...
				<div class="pull-right">
					<ul class="action-icon-list">
						<li><a href="<?=site_url("syslog/nation-type")?>">Nation type</a></li>
						...
						<li><a href="<?=site_url("syslog/nations/add")?>"><i class="fa fa-plus" aria-hidden="true"></i> Add</a></li>
					</ul>
				</div>
			</h1>
		</div>
		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" class="<?=(!$r?"active":"")?>"><a href="<?="#".$this->util->slug($regions[$r])?>" aria-controls="<?=$this->util->slug($regions[$r])?>" role="tab" data-toggle="tab"><?=ucwords(str_replace( '-',' ', $regions[$r]))?></a></li>
				<? } ?>
			</ul>
				...
				<div role="tabpanel" class="tab-pane <?=(!$r?"active":"")?>" id="<?=$this->util->slug($regions[$r])?>">
					<table class="table table-bordered table-hover">
						...
						<tr class="row<?=$item->active?>">
							...
							<td>
								<a href="<?=site_url("syslog/nations/edit/{$item->id}")?>"><?=$item->name?></a>
								<ul class="action-icon-list">
									<li><a href="<?=site_url("syslog/nations/edit/{$item->id}")?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></li>
