		...
		<div class="row">
			...
			<div class="col-md-3" style="padding-right: 0;">
				<div class="input-group mb-3">
					<input type="text" class="form-control" name="search" placeholder="Search News" value="<?=$search_text?>" aria-label="Search News" aria-describedby="button-addon2">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("news/{$items[0]->alias}")?>">
			...
			<div class="col-md-8">
				<div class="row">
					<? if (!empty($items[1])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[1]->alias}")?>">
					...
					<? if (!empty($items[2])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[2]->alias}")?>">
							<div class="re-item border-red">
					...
					<? if (!empty($items[3])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[3]->alias}")?>">
							<div class="re-item border-red">
		...
		<div class="row">
			<div class="col-md-7">
				<div class="row">
					<? if (!empty($items[4])) { ?>
					<div class="col-md-5">
						<a href="<?=site_url("news/{$items[4]->alias}")?>">
							<div class="re-item border-red">
					...
					<div class="col-md-7">
						<div class="mer-item border-red">
							<a href="<?=site_url("news/{$items[5]->alias}")?>">
			...
			<div class="col-md-5">
				<div class="row">
					<? if (!empty($items[6])) { ?>
					<div class="col-md-6">
						<a href="<?=site_url("news/{$items[6]->alias}")?>">
							<div class="re-item border-red">
					...
					<? if (!empty($items[7])) { ?>
					<div class="col-md-6">
						<a href="<?=site_url("news/{$items[7]->alias}")?>">
							<div class="re-item border-red">
		...
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<? if (!empty($items[8])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[8]->alias}")?>">
							<div class="re-item border-red">
					...
					<? if (!empty($items[9])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[9]->alias}")?>">
							<div class="re-item border-red">
					...
					<? if (!empty($items[10])) { ?>
					<div class="col-md-4">
						<a href="<?=site_url("news/{$items[10]->alias}")?>">
							<div class="re-item border-red">
			...
			<div class="col-md-4">
				<div class="mer-item border-red">
					<a href="<?=site_url("news/{$items[11]->alias}")?>">
