			...
			<div style="position: relative">
				...
				<div class="owl-carousel owl-theme carousel-resources">
					...
					<div class="item" data-merge="2">
						<div class="mer-item">
							<a href="<?=site_url("news/{$type}/{$relateditems[0]->alias}")?>">
								<div class="bg-item" style="background-image: url(<?=BASE_URL.$relateditems[0]->thumbnail?>);">
									<div class="info">
										...
										<a href="<?=site_url("news/{$type}/{$relateditems[0]->alias}")?>" class="btn-viewmore">View more</a>
										<div class="date">
					...
					<div class="item">
						<a href="<?=site_url("news/{$type}/{$relateditems[$i]->alias}")?>">
							...
							<a href="<?=site_url("news/{$type}/{$relateditems[$i]->alias}")?>" class="btn btn-viewmore">view more</a>
						</a>
					</div>
					<? } ?>
				</div>
