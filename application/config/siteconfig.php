...
define("PASSWORD", "");
define("DATABASE", "global_offshore");
define("DRIVER",   "mysqli");

// --------------------------------------------
// USER DEFINE
// --------------------------------------------
define("SITE_NAME", 	"Global Offshore");
...
define("PAYPAL_CANCEL_URL",		BASE_URL."/apply-company-services.html");
define("PAYPAL_RETURN_URL",		BASE_URL."/apply-company-services.html");
...
define("OP_RETURN_URL",			BASE_URL."/apply-company-services.html");
