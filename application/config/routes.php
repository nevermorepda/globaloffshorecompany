...
$route['our-services'] = "our-services/index";
$route['our-services/(:any)'] = "our-services/index/$1";
$route['our-services/(:any)/(:any)'] = "our-services/index/$1/$2";
$route['our-services/(:any)/(:any)/(:any)'] = "our-services/index/$1/$2/$3";
$route['jurisdictions/(:any)'] = "jurisdictions/index/$1";
$route['jurisdictions/(:any)/(:any)'] = "jurisdictions/index/$1/$2";
$route['resources'] = "resources/index";
$route['resources/(:any)'] = "resources/index/$1";
$route['resources/(:any)/(:any)'] = "resources/index/$1/$2";
...
$route['service-news'] = "service-news/index";
$route['service-news/(:any)'] = "service-news/index/$1";
$route['service-news/(:any)/(:any)'] = "service-news/index/$1/$2";
$route['service-blogs'] = "service-blogs/index";
$route['service-blogs/(:any)'] = "service-blogs/index/$1";
$route['service-blogs/(:any)/(:any)'] = "service-blogs/index/$1/$2";